export enum Errors {
   ...
   */
  ZERO_CAPTCHA_FILESIZE = 'ZERO_CAPTCHA_FILESIZE',
  /**
   * The size of the captcha you are uploading is more than 50,000 bytes.
   */
  TOO_BIG_CAPTCHA_FILESIZE = 'TOO_BIG_CAPTCHA_FILESIZE',
  /**
   ...
   */
  NO_SUCH_CAPCHA_ID = 'NO_SUCH_CAPCHA_ID',
  /**
   ...
   */
  RECAPTCHA_INVALID_SITEKEY = 'RECAPTCHA_INVALID_SITEKEY',
}
